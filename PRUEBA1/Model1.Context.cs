...
namespace PRUEBA1
{
    ...
    public partial class TESTEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> SearchOrder(Nullable<int> orderId, ObjectParameter message)
        {
            var orderIdParameter = orderId.HasValue ?
                new ObjectParameter("OrderId", orderId) :
                new ObjectParameter("OrderId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SearchOrder", orderIdParameter, message);
        }
